...
namespace AssetBundleBrowser
{
    internal class AssetListTree : TreeView
    {
        ...
        private static MultiColumnHeaderState.Column[] GetColumns()
        {
            ...
            retVal[3].minWidth = 26;
            retVal[3].width = 26;
            retVal[3].maxWidth = 26;
            retVal[3].headerTextAlignment = TextAlignment.Left;
            retVal[3].canSort = false;
            retVal[3].autoResize = false;

            retVal[4].headerContent = new GUIContent("同名", "同名标记");
            retVal[4].minWidth = 36;
            retVal[4].width = 36;
            retVal[4].maxWidth = 36;
        ...
        private void CellGUI(Rect cellRect, AssetBundleModel.AssetTreeItem item, int column, ref RowGUIArgs args)
        {
            ...
            switch (column)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    if (item.asset.isSameName)
                    {
                        DefaultGUI.Label(cellRect, "同名", args.selected, args.focused);
                    }
                    else
                    {
                        DefaultGUI.Label(cellRect, "", args.selected, args.focused);
                    }
                    break;
            }
            GUI.color = oldColor;
