...
namespace AssetBundleBrowser.AssetBundleModel
{
    ...
    internal class BundleDataInfo : BundleInfo
    {
        ...
        private static Dictionary<string, int> m_sameName = new Dictionary<string, int>();
        ...
        internal override void RefreshAssetList()
        {
            ...
            m_sameName = new Dictionary<string, int>();
            ...
            foreach (var assetName in assets)
            {
                ...
                if (System.String.IsNullOrEmpty(bundleName))  
                {
                    ...
                    if(!System.String.IsNullOrEmpty(bundleName))
                    {
                        ...
                        {
                            int sameIndex = 0;
                            if (!m_sameName.TryGetValue(newAsset.displayName, out sameIndex))
                            {
                                m_sameName.Add(newAsset.displayName, 1);
                                newAsset.isSameName = false;
                            }
                            else
                            {
                                newAsset.isSameName = true;
                            }
